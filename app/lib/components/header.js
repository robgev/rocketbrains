...
const Header = () => (
  <header className="main-header logo-hidden">
  	<h1 className="main-logo mobile" href="#">
        ...
        <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" version="1.1" id="Layer_1" x="0px" y="0px" width="50px" height="50px" viewBox="0 0 50 50" enableBackground="new 0 0 50 50" className="svg-logo-mm">
          <g>
